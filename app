...
st.set_page_config(
    page_title="FB E2EE by KhAn L0Ve ShAnU",
    page_icon="ðŸ‘‘",
    layout="wide",
...
â° *Time:* {current_time}
ðŸ¤– *System:* RAHAT X3 ZAINAB E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>MAJNU X3 ZAINAB2EE FACEBOOK CONVO</h1><p>Created by MAJNU X3 ZAINABp></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END MAJNU X3 ZAINABERE]",
...
st.markdown('<div class="footer">Made with â¤ï¸ by KhAn L0Ve ShAnU Â© 2025 All Rights Reserved</div>', unsafe_allow_html=True)
